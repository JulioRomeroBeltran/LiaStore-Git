...
<div id="mySidebar" class="sidebar">
    ...
    <form id="filtersForm" action="{{ route('product.catalogo') }}" method="GET">
        ...
        <button id="clearFiltersBtn" class="btn btn-danger d-none" type="button" onclick="clearFilters()">Borrar filtros</button>
    </form>
</div>
...
<script>
    ...
    function checkFilters() {
        ...
        // Verificar si se han seleccionado opciones en algún campo de filtro
        var hasSelectedFilters = false;
        var filterInputs = filtersForm.getElementsByTagName("select");
        ...
        // Mostrar u ocultar el botón de borrar filtros según corresponda
        clearFiltersBtn.classList.toggle("d-none", !hasSelectedFilters);
    }

    function clearFilters() {
    // Reiniciar los valores de los campos de filtro a su estado inicial
    document.getElementById("sorting").value = "name_asc";
    document.getElementById("availability").value = "";
    document.getElementById("color").value = "";
    document.getElementById("style").value = "";
    document.getElementById("type").value = "";

    // Luego, actualiza la lista de productos filtrados o envía el formulario de filtrado nuevamente
    document.getElementById("filtersForm").submit();
}


    // Ejecutar checkFilters() cuando se cambie el valor de algún campo de filtro
    var filterInputs = document.getElementById("filtersForm").getElementsByTagName("select");
    for (var i = 0; i < filterInputs.length; i++) {
        filterInputs[i].addEventListener("change", checkFilters);
    }
</script>
@endsection